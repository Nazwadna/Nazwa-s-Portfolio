...
import laWebsite from './assets/Projects/la.png';
import academyNextTopModel from './assets/Projects/Academy Next Top Model.png';
import levioraFashion from './assets/Projects/Leviora.png';
import jewepeWeeding from './assets/Projects/jewepe weeding.png';
import perpusGas from './assets/Projects/Perpus Gas.png';
import preloved from './assets/Projects/preloved.png';
import linktreeQr from './assets/Projects/barcode linktree.png';
  ...
  const projects = [
    {
      ...
      image: laWebsite,
      figmaLink: "https://www.figma.com/design/ikdzIxZeY8x5oIdPl0pZzZ/Kelurahan-Lenteng-Agung-Design?node-id=0-1&t=FQIoAoxjCZXxXPwP-1",
      githubLink: "https://github.com/Nazwadna/kelurahan-la-main.git",
      livePreviewLink: "https://www.figma.com/proto/ikdzIxZeY8x5oIdPl0pZzZ/Kelurahan-Lenteng-Agung-Design?node-id=0-1&t=hU8cBqoWuYfhM54C-1",
      description:
        "A public service and complaint platform designed to improve access to information, simplify complaint submissions, and support residents through a cleaner digital experience. Role: Project Manager - Led project planning, task allocation, and implementation.",
      ...
      highlights: [
        ...
        "Implemented AI chatbot feature to provide instant assistance and automated responses to resident inquiries.",
      ],
    },
    {
      ...
      image: academyNextTopModel,
      figmaLink: "https://www.figma.com/design/nnAZEMHkD7r4pRfjgxjjHk/Website-Academy-Next-Top-Model?node-id=0-1&t=10zxFPACS7MvkWoH-1",
      githubLink: "https://github.com/Nazwadna/academyntm2-finale.git",
      livePreviewLink: "https://www.figma.com/proto/nnAZEMHkD7r4pRfjgxjjHk/Website-Academy-Next-Top-Model?node-id=0-1&t=10zxFPACS7MvkWoH-1",
      description:
        "A responsive website concept for a modeling academy with a modern fashion-forward feel, focused on clear navigation, strong visual hierarchy, and an intuitive registration journey. Currently developing this project for my thesis with additional AI chatbot features.",
      ...
      tools: ["Figma"],
      image: levioraFashion,
      figmaLink: "https://www.figma.com/design/BsfZMYqS7Fqefuauhb6KXh/E-commerce?node-id=0-1&t=QtNUKDd75wvsvYRi-1",
      githubLink: null,
      livePreviewLink: "https://www.figma.com/proto/BsfZMYqS7Fqefuauhb6KXh/E-commerce?node-id=0-1&t=QtNUKDd75wvsvYRi-1",
      description:
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1f] text-white">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-[-8rem] top-[-5rem] h-[26rem] w-[26rem] rounded-full bg-blue-600/10 blur-3xl" />
        <div className="absolute right-[-6rem] top-[10rem] h-[24rem] w-[24rem] rounded-full bg-indigo-500/10 blur-3xl" />
        <div className="absolute bottom-[-8rem] left-[18%] h-[28rem] w-[28rem] rounded-full bg-slate-600/10 blur-3xl" />
      </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-8 md:px-10 md:pb-24 md:pt-10">
        <nav className={`mb-10 flex items-center justify-between rounded-full border border-white/10 bg-white/5 px-5 py-3 backdrop-blur-xl transition-all duration-300 ${scrolled ? 'shadow-lg' : ''}`}>
          ...
          <div className="hidden gap-6 text-sm text-white/60 md:flex">
            <button 
              ...
              className={`transition-colors duration-200 ${activeSection === 'about' ? 'text-blue-300' : 'hover:text-white'}`}
            >
              About
            </button>
            <button 
              onClick={() => scrollToSection('projects')}
              className={`transition-colors duration-200 ${activeSection === 'projects' ? 'text-blue-300' : 'hover:text-white'}`}
            >
              Projects
            </button>
            <button 
              onClick={() => scrollToSection('skills')}
              className={`transition-colors duration-200 ${activeSection === 'skills' ? 'text-blue-300' : 'hover:text-white'}`}
            >
              Skills
            </button>
            <button 
              onClick={() => scrollToSection('contact')}
              className={`transition-colors duration-200 ${activeSection === 'contact' ? 'text-blue-300' : 'hover:text-white'}`}
            >
              Contact
            </button>
          </div>
        ...
        <div className="grid items-center gap-10 md:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="mb-4 inline-flex rounded-full border border-blue-400/20 bg-blue-500/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.25em] text-blue-200">
              Creative Portfolio
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a href="#projects" className="group rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 text-sm font-medium text-white shadow-[0_12px_30px_rgba(37,99,235,0.35)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_15px_40px_rgba(37,99,235,0.45)] hover:from-blue-500 hover:to-indigo-500 inline-block">
                View Projects
              </a>
              <a href="#contact" className="group rounded-full border border-white/12 bg-white/5 px-6 py-3 text-sm font-medium text-white/85 transition-all duration-300 hover:bg-white/10 hover:border-blue-300/30 hover:text-blue-200 hover:shadow-[0_8px_25px_rgba(37,99,235,0.15)] inline-block">
                Contact
              </a>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-[#151826] to-[#0d1018] p-7 shadow-[0_18px_40px rgba(0,0,0,0.24)]">
            <p className="text-sm uppercase tracking-[0.22em] text-blue-200/70">Certifications</p>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-7 shadow-[0_18px_40px rgba(0,0,0,0.2)] backdrop-blur-xl">
            <p className="text-sm uppercase tracking-[0.22em] text-indigo-200/75">Creative Experience</p>
            <div className="mt-5 space-y-3">
              {experience.map((item) => (
      ...
      <section id="contact" className="mx-auto max-w-7xl px-6 pb-20 md:px-10">
        <div className="overflow-hidden rounded-[2.4rem] border border-blue-400/10 bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.08),transparent_22%),radial-gradient(circle_at_bottom_right,rgba(99,102,241,0.10),transparent_25%),linear-gradient(135deg,#0a0f1f_0%,#0d1b2a_55%,#0a1728_100%)] px-8 py-10 text-white shadow-[0_20px_60px_rgba(0,0,0,0.35)] md:px-10 md:py-12">
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-blue-200/75">Contact</p>
              <h2 className="mt-4 max-w-3xl text-4xl font-semibold leading-tight md:text-6xl">
                Let&apos;s Work
                <span className="block bg-gradient-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent pb-4">
                  Together
                </span>
              </h2>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <a
                  ...
                  className="group rounded-[1.6rem] border border-white/10 bg-white/5 p-5 transition-all duration-300 hover:border-blue-300/30 hover:bg-white/8 hover:shadow-[0_12px_35px_rgba(37,99,235,0.20)] hover:-translate-y-[-2px]"
                >
                  <p className="text-xs uppercase tracking-[0.22em] text-white/45 group-hover:text-blue-200/75 transition-colors">Email</p>
                  <p className="mt-3 text-lg font-medium text-white group-hover:text-blue-100 transition-colors">nazwa.audina64@gmail.com</p>
                  <p className="mt-2 text-sm text-white/45 group-hover:text-blue-200/75 transition-colors">Send a message ↗</p>
                </a>

                <a
                  href="tel:+6282298795797"
                  className="group rounded-[1.6rem] border border-white/10 bg-white/5 p-5 transition-all duration-300 hover:border-indigo-300/30 hover:bg-white/8 hover:shadow-[0_12px_35px_rgba(99,102,241,0.20)] hover:-translate-y-[-2px]"
                >
                  <p className="text-xs uppercase tracking-[0.22em] text-white/45 group-hover:text-indigo-200/75 transition-colors">Phone</p>
                  <p className="mt-3 text-lg font-medium text-white group-hover:text-indigo-100 transition-colors">+62 822-9879-5797</p>
                  <p className="mt-2 text-sm text-white/45 group-hover:text-indigo-200/75 transition-colors">Call or WhatsApp ↗</p>
                </a>
              </div>
            ...
            <div className="grid gap-5">
              <div className="rounded-[1.9rem] border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
                <div className="grid gap-5 md:grid-cols-[180px_1fr] md:items-center">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-[0.22em] text-blue-200/75">Quick Access</p>
                    ...
                    <a
                      ...
                      className="group mt-5 inline-flex rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-3 text-sm font-medium text-white shadow-[0_12px_30px_rgba(37,99,235,0.25)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_15px_40px_rgba(37,99,235,0.35)] hover:from-blue-500 hover:to-indigo-500"
                    >
                      Open Linktree ↗
                    </a>
                  </div>
              ...
              <div className="rounded-[1.9rem] border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group rounded-[1.2rem] border border-white/10 bg-[#0d1b2a] px-4 py-4 text-sm text-white/82 transition-all duration-300 hover:border-blue-300/30 hover:bg-blue-500/10 hover:text-blue-200 hover:shadow-[0_8px_25px_rgba(37,99,235,0.15)] hover:-translate-y-[-1px]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group rounded-[1.2rem] border border-white/10 bg-[#0d1b2a] px-4 py-4 text-sm text-white/82 transition-all duration-300 hover:border-slate-300/30 hover:bg-slate-500/10 hover:text-slate-200 hover:shadow-[0_8px_25px_rgba(71,85,105,0.15)] hover:-translate-y-[-1px]"
                  >
                    github.com/Nazwadna
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group rounded-[1.2rem] border border-white/10 bg-[#0d1b2a] px-4 py-4 text-sm text-white/82 transition-all duration-300 hover:border-indigo-300/30 hover:bg-indigo-500/10 hover:text-indigo-200 hover:shadow-[0_8px_25px_rgba(99,102,241,0.15)] hover:-translate-y-[-1px] sm:col-span-2"
                  >
                    linktr.ee/nazwaadna
                  </a>
                </div>
    ...
    <button
        ...
        className="group fixed bottom-8 right-8 z-50 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 p-4 text-white shadow-[0_12px_30px_rgba(37,99,235,0.35)] transition-all duration-300 hover:scale-[1.05] hover:shadow-[0_15px_40px_rgba(37,99,235,0.45)] hover:from-blue-500 hover:to-indigo-500"
